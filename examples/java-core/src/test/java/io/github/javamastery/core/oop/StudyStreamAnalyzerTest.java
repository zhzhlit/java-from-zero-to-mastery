...
class StudyStreamAnalyzerTest {
    ...
    void filtersLessonTitlesWithLambdaPredicate() {
        List<CourseLesson> lessons = List.of(
                new CourseLesson("集合", 40),
                new CourseLesson("文件 I/O", 45),
                new CourseLesson("日期与时间 API", 50));
    ...
    private static List<CourseLesson> listWithNullLesson() {
        return java.util.Arrays.asList(new CourseLesson("集合", 40), null);
    }
